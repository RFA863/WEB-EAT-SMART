                ...
                <div className='bg-backgroundPrimaryBolder rounded-2xl'>
                    {/* Header */}
                        <div className="bg-backgroundPrimary shadow-md p-6">
                            <h1 className="text-contentBrand self-center text-2xl font-semibold whitespace-nowrap">- Smart Chat -</h1>
                        </div>
                    {/* Chat Area */}
                        <div className="flex-1 overflow-y-auto p-6 ">
                            ...
                            {/* Input Area */}
                                <div className="bg-white p-4 shadow-inner flex items-center rounded-2xl">
                                    ...
                                    />
                                    <button className="ml-4 bg-backgroundBrand text-white px-4 py-2 rounded-lg shadow-md hover:bg-orange-700">
                                    Send
                                    </button>
                                </div>
                        </div> 
